    ...
    <DialogPortal data-slot="dialog-portal">
      ...
      <DialogPrimitive.Content
        ...
        className={cn(
          ...
          // على الهاتف: يظهر في أسفل الشاشة
          "bottom-0 left-0 right-0 rounded-t-2xl max-h-[90vh] overflow-y-auto",
          // على الشاشات الكبيرة: يظهر في المنتصف
          "md:bottom-auto md:top-[50%] md:left-[50%] md:right-auto md:translate-x-[-50%] md:translate-y-[-50%] md:rounded-lg md:max-h-[90vh]",
          "p-4 md:p-6",
          className
        )}
        {...props}
